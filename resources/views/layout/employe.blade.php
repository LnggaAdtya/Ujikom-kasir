                   ...
                   <ul class="navbar-nav ms-auto d-flex align-items-center">
                       ...
                       <li>
                               <div class="profile-pic">
                                   <span class="text-white font-medium">Selamat datang kasir!</span>
                               </div>
                       </li>
                       <!-- ============================================================== -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/employe"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/employeProduct"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/sale"
                                aria-expanded="false">
